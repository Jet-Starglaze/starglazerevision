...
const mobilePrimaryButtonClass =
  "inline-flex min-h-10 items-center justify-center rounded-xl bg-sky-700 px-3 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-sky-800 dark:bg-sky-600 dark:hover:bg-sky-500 md:hidden";
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200/70 bg-white/86 shadow-sm shadow-slate-950/5 backdrop-blur-xl dark:border-slate-800/70 dark:bg-slate-950/84 dark:shadow-black/20">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex border-t border-slate-200/70 pb-3 pt-2 md:hidden dark:border-slate-800/70">
